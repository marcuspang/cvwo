...
import { useState, useRef, useContext, FormEventHandler } from "react";
...
const AuthForm = () => {
  ...
  const endpoint = loggingIn ? "/signin" : "/signup";
